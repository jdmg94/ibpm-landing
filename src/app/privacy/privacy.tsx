    ...
    <WavyBackground>
      <section className={styles.hero}>
        <ContentCard>
          ...
          <h3>Security:</h3>
          iBPM has implemented reasonable security measures to protect your
          information from unauthorized access or disclosure. However, no app or
          internet service is completely secure. We cannot guarantee the
          security of your information.
          <h3>Children's Privacy:</h3>
          iBPM is not intended for children under the age of 13. We do not
